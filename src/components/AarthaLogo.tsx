...
export default function AarthaLogo({
  ...
  return (
    <div className={`flex items-center gap-2.5 select-none ${className}`}>
      ...
      <div 
        className="relative flex items-center justify-center rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 p-1 shadow-sm transition-all duration-200 group-hover:scale-105"
        style={{ width: size, height: size }}
      >
        <Image
          src="/brand/aartha-logo.png"
